...
<ul class="pagination" style="margin-left: 30%;">
  <!-- <li class="page-item"><a class="page-link" href="BoardServlet?command=board_list&pageno=1">first</a></li> -->
  
  
  <%if(pageno != 0) {%>
  	<li class="page-item"><a class="page-link" href="list.do?id=2&pageno=<%=prev_pageno%>">이전</a></li>
  	<%for(int i =page_sno;i<=page_eno;i++){%>
		<%if(pageno == i){ %>
			<li class="page-item active">
			<a class="page-link active" href="list.do?id=2&pageno=<%=i %>"><%=i %></a>
		<%}else{ %>
			<li class="page-item">
			<a class="page-link" href="list.do?id=2&pageno=<%=i %>"><%=i %></a>
		<%} %>
	</li>
	<%} %>
	<li class="page-item"><a class="page-link" href="list.do?id=2&pageno=<%=next_pageno%>">다음</a></li>
  <%} %>
  
  
  
  <%-- <li class="page-item"><a class="page-link" href="BoardServlet?command=board_list&pageno=<%=total_page %>">last</a></li> --%>
</ul>