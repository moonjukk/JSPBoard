...
public class BoardSearchPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public BoardSearchPageServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<BoardManageVO> boardSearchList = bDao.searchListByTitle(title);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("search.jsp?query="+title);
